...
class Forms extends Component {
  constructor(props) {
    ...
    this.loopTabs=this.loopTabs.bind(this);
    this.state = {
      collapse: true,
      fadeIn: true,
      timeout: 300
  ...
  loopTabs(n){
    ...
    return(
    <Row>
       {content.map((n)=>(<Col xs="12" md="6"><Tab match_pdf_info='' match_content_info='' match_content=''></Tab></Col>))};
    ...
    async handleSubmit(event) {
       ...
       await fetch(base+'/search/search', {
          method: 'post',
                  ...
                  <FormGroup row>
                    <Col md="12">
                      <InputGroup>
                        ...
                        <Input type="text" id="input1-group2" name="input1-group2" placeholder="What you want to search?" />
                      </InputGroup>
                    </Col>
                  </FormGroup>
                  {/* <FormGroup row>
